...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/nameless-tooth-50c0
```

A live public deployment of this template is available at [https://nameless-tooth-50c0.templates.workers.dev](https://nameless-tooth-50c0.templates.workers.dev)
